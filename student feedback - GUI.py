...
headerlabel = ttk.Label(frame_header, text='''             EASWARI
ENGINEERING COLLEGE''', foreground='red',background='white',font=('arial', 36,'bold'))
headerlabel.grid(row=0,column=1)
headerlabel1 = ttk.Label(frame_header, text='''         STUDENTS FEEDBACK          ''', foreground='black',background='white',font=('arial', 24,'bold'))
headerlabel1.grid(row=1,column=1,pady=10)
messagelabel = ttk.Label(frame_header,text='PLEASE TELL US WHAT YOU THINK',background='white',foreground='purple', font=('Arial', 10))
...
dep=StringVar()
# cmnt= StringVar()
namelabel = ttk.Label(frame_content, text='NAME:',font=('arial',10,'bold'),background='white',)
...
entry_name.grid(row=0, column=1,columnspan=2,padx=5,pady=10,sticky='sw')
